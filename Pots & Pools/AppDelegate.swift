...
var usersCollection: RemoteMongoCollection<UserItem>!
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //let newClient = try! Stitch.initializeDefaultAppClient(withClientAppID: Constants.STITCH_APP_ID)
        ...
        usersCollection = MongoClient.db(Constants.TODO_DATABASE).collection(Constants.USERS_ITEMS_COLLECTION, withCollectionType: UserItem.self)
        
        self.window = UIWindow(frame: UIScreen.main.bounds)
        
        let storyboard = UIStoryboard(name: "Main", bundle: nil)

        let initialViewController = storyboard.instantiateViewController(withIdentifier: "Landing Controller")
